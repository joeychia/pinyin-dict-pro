...
- 【note】由于集成了英文词典，包体积增加至约 10MB，内存占用增加至约 50MB (运行时)
- 【benchmark】English dictionary coverage: 100%
- 【benchmark】Speed comparison: `pinyinEn` is ~4x faster than before (Trie FMM vs AC)
